...
from ....data.vla_data.transform import prepare_images, prepare_state, prepare_language, prepare_action
IMAGE_KEYS = (
    "base_0_rgb",
    "left_wrist_0_rgb",
    "right_wrist_0_rgb",
...
class PI0Policy(PreTrainedPolicy):
    ...
    def select_action(
        ...
        images, img_masks = prepare_images(observation)
        state = prepare_state(observation)
        lang_tokens, lang_masks = prepare_language(observation)
